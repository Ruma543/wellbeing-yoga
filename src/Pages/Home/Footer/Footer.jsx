...
const Footer = () => {
  return (
    <div className="grid lg:grid-cols-3 grid-cols-1 bg-black gap-3 px-5 py-7 w-full left-0 bottom-0 block">
      <div className="px-4 py-6 w-11/12">
      ...
      <div className="flex flex-col items-center justify-center px-4 py-6 w-11/12">
